...
async function previewCall(name: string, args: Record<string, unknown>): Promise<ToolResult> {
  ...
  if (name === "ui_check_for_updates") {
    return { structuredContent: { update: { currentVersion: "0.2.1", latestVersion: "0.2.1", updateAvailable: false, checked: true, checkedAt: new Date().toISOString(), releaseUrl: "https://github.com/renoir1220/esse/releases/tag/v0.2.1" } } };
  }
