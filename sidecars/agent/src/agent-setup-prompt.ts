import { buildProviderConfigGuidance } from './provider-config-guide';
...
export function buildAgentSetupPrompt(connection: EsseMcpConnection): string {
  ...
  return [
    ...
    '',
    buildProviderConfigGuidance({
      providerConfigPath: connection.providerConfigPath,
      settingsConfigPath: connection.settingsConfigPath,
    }),
    '',
    '```json',
