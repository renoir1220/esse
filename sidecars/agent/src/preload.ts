...
const bridge: EsseDesktopBridge = {
  ...
  copyBatchReference: (batchId: string) => ipcRenderer.invoke('references:copy-batch', batchId),
  copyImageId: (batchId: string, imageId: string) => ipcRenderer.invoke('references:copy-image-id', batchId, imageId),
